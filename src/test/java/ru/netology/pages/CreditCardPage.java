...
public class CreditCardPage {
    ...
    public CreditCardPage () {paymentForm.shouldBe(visible);
    }

    public void fillingPaymentFormForCreditCard (DataGenerator.CardInfo cardInfo) {
    ...
    public void expiredMonth() {expiredLastMonthField.shouldBe(visible);
    }

    public void expiredYear() {expiredLastYearField.shouldBe(visible);
    }
}
